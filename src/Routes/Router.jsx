...
const router = createBrowserRouter([
  {
    ...
    children:[
        ...
        },
        {
            ...
            loader: async () => {
              try {
                const res = await fetch('https://seasons-server.vercel.app/itemCount');
        ...
        },
        {
          ...
          loader: async ({params}) => {
            try {
              const res = await fetch(`https://seasons-server.vercel.app/api/v1/all-foods/${params.id}`);
              if (!res.ok) throw new Error('Fetch failed');
              return await res.json();
            } catch(err) {
              console.error(err);
        ...
        {
          path: '/admin-panel',
          element: <PrivetRoute><AdminPanel></AdminPanel></PrivetRoute>
        }
    ]
  },
  {
