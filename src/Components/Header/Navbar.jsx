      ...
      <div className="flex justify-between max-w-5xl px-3 mx-auto py-2 items-center ">
            ...
            <div className="hidden lg:block">
                <div className="flex gap-4 mr-5 ">
                    ...
                    <NavLink to={'/admin-panel'} className={({isActive})=> isActive ? 'text-yellow-500 font-semibold hover:text-yellow-700 hover:underline cursor-pointer' : 'text-white font-semibold hover:text-yellow-700 hover:underline cursor-pointer' }>Admin Panel</NavLink>
                </div>  
            </div>
            <div className="flex items-center gap-2 z-50">
                ...
                <div className="drawer drawer-end lg:hidden z-50">
                    ...
                    <div className="drawer-side">
                        ...
                        <li>
                            <NavLink to={'/admin-panel'} className={({isActive})=> isActive ? 'underline text-red-500 hover:text-blue-600 cursor-pointer' : 'text-black hover:text-blue-600 cursor-pointer' }>Admin Panel</NavLink>
                        </li>
                        {
